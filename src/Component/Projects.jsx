...
function Projects() {
  const projects = [
    ...
    { title: "Project 3", description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout..", 
        image: "https://i.etsystatic.com/7587698/r/il/5c44aa/2079780425/il_fullxfull.2079780425_s6bu.jpg" },
  ];
